...
<body>
    <h1 class="container my-10 text-4xl font-extrabold tracking-tight leading-none text-gray-900  dark:text-white">
        Create <span class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">
            your todo list</span></h1>
    <main>
        <div class="container mb-5">
            <a href="{{ route('todo.create') }}" type="button"
        ...
        <div class="container w-1/3">
            ...
            @if (session()->has('edit'))
                <div id="alert-1" class="flex p-4 mb-4 bg-yellow-100 rounded-lg dark:bg-yellow-200" role="alert">
        ...
        <div class="container grid gap-4 grid-cols-4">
                ...
                <div
                    ...
                    <a href="{{ route('todo.show', $todo->id) }}">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            {{ Str::limit($todo->title, 30) }}</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                        {{ Str::limit($todo->description, 150) }}</p>
                    ...
                    <div class="inline-flex rounded-md shadow-sm" role="group">
                        ...
                        <button type="submit" type="button" data-modal-toggle="popup-modal"
            ...
            @empty
                <figure class="my-10 max-w-screen-md">
                    <svg aria-hidden="true" class=" mb-3 w-12 h-12 text-gray-400 dark:text-gray-600"
                    ...
                    <blockquote>
                        <p class="text-2xl italic font-medium text-gray-900 dark:text-white">“The only man who never
                            makes mistakes is the man who never does anything.”</p>
                    </blockquote>
                    <figcaption class="flex items-center mt-6 space-x-3">
                        ...
                        <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                            <cite class="pr-3 font-medium text-gray-900 dark:text-white">Theodore Roosevelt</cite>
                            <cite class="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Presiden Amerika
                                Serikat
                            </cite>
                        </div>
                    </figcaption>
    ...
    <script>
        const alertOne = document.getElementById('alert-1');
        ...
        const dismiss = new Dismiss(alertOne)
    </script>
</body>
